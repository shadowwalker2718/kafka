...
public class CommonClientConfigs {
    ...
    public static final String BOOTSTRAP_SERVERS_DOC = "A list of host/port pairs to use for establishing the initial connection to the Kafka cluster."
    		+ " The client will make use of all servers irrespective of which servers are specified here for bootstrapping&mdash;this list only impacts "
    		+ "the initial hosts used to discover the full set of servers. This list should be in the form "
